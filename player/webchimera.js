...
wjs.init.prototype.onMediaChanged = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onMediaChanged(wjs_function);
    return this;
};
...
wjs.init.prototype.onIdle = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onIdle(wjs_function);
    return this;
};
...
wjs.init.prototype.onOpening = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onOpening(wjs_function);
    return this;
};
...
wjs.init.prototype.onBuffering = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onBuffering(wjs_function);
    return this;
};
...
wjs.init.prototype.onPlaying = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onPlaying(wjs_function);
    return this;
};
...
wjs.init.prototype.onPaused = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onPaused(wjs_function);
    return this;
};
...
wjs.init.prototype.onEnded = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onEnded(wjs_function);
    return this;
};
...
wjs.init.prototype.onError = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onError(wjs_function);
    return this;
};
...
wjs.init.prototype.onStopped = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onStopped(wjs_function);
    return this;
};
...
wjs.init.prototype.onTime = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onTime(wjs_function);
    return this;
};
...
wjs.init.prototype.onPosition = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onPosition(wjs_function);
    return this;
};
...
wjs.init.prototype.onMessage = function(wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onMessage(wjs_function);
    return this;
};
...
wjs.init.prototype.emitJsMessage = function(wjs_message) {
    if (this.allElements.length == 1) this.plugin.emitJsMessage(wjs_message);
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).emitJsMessage(wjs_message);
    return this;
};
...
wjs.init.prototype.catchEvent = function(wjs_event, wjs_function) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).catchEvent(wjs_event, wjs_function);
    return this;
};
...
wjs.init.prototype.loadSettings = function(wjs_localsettings) {
    if (this.allElements.length == 1) this.plugin.emitJsMessage(JSON.stringify(wjs_localsettings));
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).loadSettings(wjs_localsettings);
    return this;
};
...
wjs.init.prototype.audioTrack = function(newTrack) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).audioTrack(newTrack);
    return this;
}
...
wjs.init.prototype.time = function(newTime) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).time(newTime);
    return this;
}
wjs.init.prototype.position = function(newPosition) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).position(newPosition);
    return this;
}
wjs.init.prototype.rate = function(newRate) {
        if (this.allElements.length == 1) {
            ...
            for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).rate(newRate);
        return this;
    }
...
wjs.init.prototype.swapItems = function(newX, newY) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).swapItems(newX, newY);
    return this;
}
wjs.init.prototype.advanceItem = function(newX, newY) {
        if (this.allElements.length == 1) {
            ...
            for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).advanceItem(newX, newY);
        return this;
    }
...
wjs.init.prototype.aspectRatio = function(newRatio) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).aspectRatio(newRatio);
    return this;
}
wjs.init.prototype.crop = function(newCrop) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).crop(newCrop);
    return this;
}
wjs.init.prototype.zoom = function(newZoom) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).zoom(newZoom);
    return this;
}
wjs.init.prototype.resetSize = function() {
        if (this.allElements.length == 1) {
            ...
            for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).resetSize();
        return this;
    }
...
wjs.init.prototype.nextFrame = function(newFrame) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).nextFrame(newFrame);
    return this;
}
...
wjs.init.prototype.hideToolbar = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[hide-toolbar]");
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).hideToolbar();
    return this;
};
wjs.init.prototype.showToolbar = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[show-toolbar]");
    else
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).showToolbar();
    return this;
};
wjs.init.prototype.toggleToolbar = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[toggle-toolbar]");
    else
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).toggleToolbar();
    return this;
};
...
wjs.init.prototype.hideUI = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[hide-ui]");
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).hideUI();
    return this;
};
wjs.init.prototype.showUI = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[show-ui]");
    else
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).showUI();
    return this;
};
wjs.init.prototype.toggleUI = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[toggle-ui]");
    else
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).toggleUI();
    return this;
};
...
wjs.init.prototype.qmlLoaded = function(action) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).qmlLoaded(action);
    return this;
};
...
wjs.init.prototype.onClicked = function(target, action) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onClicked(target, action);
...
wjs.init.prototype.onKeyPressed = function(target, action) {
    if (this.allElements.length == 1) {
        ...
        for (var prop in keyMap)
            if (keyMap.hasOwnProperty(prop)) reverseKeyMap[keyMap[prop]] = prop;
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).onKeyPressed(target, action);
...
wjs.init.prototype.preventDefault = function(type, target, action) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).preventDefault(type, target, action);
...
wjs.init.prototype.addPlayer = function(qmlsettings) {
    if (this.allElements.length == 1) {
        ...
        changeid = newid;
        changeCounter = 0;
        while (!!document.getElementById(changeid)) {
            changeCounter++;
            changeid = newid + changeCounter;
        }
        newid = changeid;
        ...
        //Only include qmlsrc property if theme is provided. Will default to 'default.qml' on local machine otherwise.
        if (qmlsettings.hasOwnProperty('theme')) {
            playerbody += '<param name="qmlsrc" value="' + qmlsettings.theme + '" />'; // if QML Source is using SSL, replace protocol
        }
        ...
        for (z = 0; z < this.allElements.length; z++) {
            if (!this.allElements[z].id) {
                ...
                while (!!document.getElementById(changeid)) {
                    changeCounter++;
                    changeid = "wjs_wrappers" + changeCounter;
                }
...
wjs.init.prototype.skin = function(skin) {
    if (this.allElements.length == 1) {
        skin.skinning = true;
        this.qmlLoaded(function() {
            this.loadSettings(skin);
        });
    } else
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).skin(skin);
    return this;
};
...
wjs.init.prototype.togglePlaylist = function() {
        if (this.allElements.length == 1) {
            ...
            for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).togglePlaylist();
        return this;
    }
...
wjs.init.prototype.addPlaylist = function(playlist) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).addPlaylist(playlist);
...
wjs.init.prototype.startPlayer = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).startPlayer();
...
wjs.init.prototype.stopPlayer = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).stopPlayer();
...
wjs.init.prototype.clearPlaylist = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).clearPlaylist();
...
wjs.init.prototype.length = function(mseconds) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).length(mseconds);
...
wjs.init.prototype.setTotalLength = function(mseconds) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).setTotalLength(mseconds);
...
wjs.init.prototype.startSubtitle = function(suburl) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).startSubtitle(suburl);
...
wjs.init.prototype.clearSubtitle = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).clearSubtitle();
...
wjs.init.prototype.subSize = function(newSize) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).subSize(newSize);
...
wjs.init.prototype.subDelay = function(newDelay) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).subDelay(newDelay);
        ...
        if (!isNaN(getDesc)) {
            if (getDesc < this.plugin.subtitle.count) {
                ...
                if (getSettings.subtitles) {
                    ...
                    for (var newDesc in wjs_target)
                        if (wjs_target.hasOwnProperty(newDesc)) {
...
wjs.init.prototype.subCount = function() {
    if (this.allElements.length == 1) {
        ...
        if (getSettings.subtitles) {
            ...
            if (wjs_keepIndex == 0) wjs_keepIndex = 1;
            for (var newDesc in wjs_target)
                if (wjs_target.hasOwnProperty(newDesc)) wjs_keepIndex++;
...
wjs.init.prototype.audioDelay = function(newDelay) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).audioDelay(newDelay);
...
wjs.init.prototype.volume = function(newVolume) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).volume(newVolume);
...
wjs.init.prototype.toggleMute = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[toggle-mute]");
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).toggleMute();
    return this;
};
...
wjs.init.prototype.mute = function(newMute) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).mute(newMute);
    return this;
};
...
wjs.init.prototype.toggleFullscreen = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).toggleFullscreen();
    return this;
};
...
wjs.init.prototype.fullscreen = function(newFullscreen) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).fullscreen(newFullscreen);
    return this;
};
...
wjs.init.prototype.next = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).next();
    return this;
};
...
wjs.init.prototype.prev = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).prev();
    return this;
};
// end function to iterate to the next playlist item
...
wjs.init.prototype.play = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).play();
    return this;
};
...
wjs.init.prototype.playItem = function(newItem) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).playItem(newItem);
    return this;
};
...
wjs.init.prototype.pause = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).pause();
    return this;
};
// end function to play current item
...
wjs.init.prototype.togglePause = function() {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).togglePause();
    return this;
};
...
wjs.init.prototype.removeItem = function(remItem) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).removeItem(remItem);
    return this;
};
...
wjs.init.prototype.notify = function(message) {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[notify]" + message);
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).notify(message);
    return this;
};
...
wjs.init.prototype.toggleSubtitles = function() {
    if (this.allElements.length == 1) this.plugin.emitJsMessage("[toggle-subtitles]");
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).toggleSubtitles();
    return this;
};
...
wjs.init.prototype.loadM3U = function(M3Uurl) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).loadM3U(M3Uurl);
...
wjs.init.prototype.setOpeningText = function(openingtext) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).setOpeningText(openingtext);
...
wjs.init.prototype.setDownloaded = function(downloaded) {
    if (this.allElements.length == 1) {
        ...
        for (z = 0; z < this.allElements.length; z++) wjs("#" + this.allElements[z].id).setDownloaded(downloaded);
