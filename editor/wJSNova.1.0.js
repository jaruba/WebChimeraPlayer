...
(function($)
{
	...
	JSNova.prototype = 
	{
		...
		generate: function()
		{
			...
			$this.Demoz = $("<select name='demos' onchange='location = \"http://jaruba.github.io/WebchimeraGUI/editor/#\"+this.options[this.selectedIndex].value;' style='width: 100%'></select>");
