...
Rectangle {
    ...
    function onBuffering( percents ) {
		...
		buffering = percents; // Set Global Variable "buffering" (required to know when to show the Buffering Announcement)
    }
	
    id: theview;
    color: "#000000"; // Set Video Background Color
	
	// Duplicate Video Demo 2 - Declare Video Layers (9 layers) and Position Them
    VlcVideoSurface {
        source: vlcPlayer;
        ...
        width: parent.width / 3 - anchors.leftMargin * 3;
        height: parent.height / 3 - anchors.topMargin * 3;
		id: video1;
		opacity: 0;
    ...
    VlcVideoSurface {
        ...
        width: parent.width / 3 - anchors.rightMargin * 3;
        height: parent.height / 3 - anchors.topMargin * 3;
		id: video2;
		opacity: 0;
		Behavior on opacity { PropertyAnimation { duration: 2000 } }
    ...
    VlcVideoSurface {
        ...
        width: parent.width / 3 - anchors.leftMargin * 3;
        height: parent.height / 3 - anchors.bottomMargin * 3;
		id: video6;
		opacity: 0;
		Behavior on opacity { PropertyAnimation { duration: 2000 } }
    }
	...
	// End Duplicate Video Demo 2 - Declare Video Layers (9 layers) and Position Them
    ...
    MouseArea {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
						toggleFullscreen();
						// Duplicate Video Demo 2 - Fullscreen Toggle
						if (firsttime == 1) {
							// Initial Animation - Resize center video layer and make other 8 layers invisible
							centervid.width = centervid.parent.width;
							centervid.height = centervid.parent.height;
							video1.opacity = 0;
							video2.opacity = 0;
							video3.opacity = 0;
							video4.opacity = 0;
							...
							// Hide center video layer too and show a normal video layer
							originalvid.visible = true;
							centervid.visible = false;
							// End Hide center video layer too and show a normal video layer
						}
						// End Duplicate Video Demo 2 - Fullscreen Toggle
					}
                }
            }
		...
		Timer {
			...
			onTriggered: {
				...
				// Duplicate Video Demo 2 - make video layers visible (except center one)				
				video1.opacity = 1;
				video2.opacity = 1;
				video3.opacity = 1;
				video4.opacity = 1;
				...
				video7.opacity = 1;
				video8.opacity = 1;
				// End Duplicate Video Demo 2 - make video layers visible (except center one)				
			}
		}
		...
		Rectangle {
			visible: dragging ? true : dragpos.containsMouse ? true : false
			anchors.bottom: parent.bottom
